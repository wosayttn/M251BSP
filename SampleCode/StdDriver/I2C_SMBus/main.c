...
void SYS_Init(void)
{
    ...
    SYS->GPC_MFPL = (SYS->GPC_MFPL & ~SYS_GPC_MFPL_PC2MFP_Msk) | SYS_GPC_MFPL_PC2MFP_I2C0_SMBSUS;
    SYS->GPC_MFPL = (SYS->GPC_MFPL & ~SYS_GPC_MFPL_PC3MFP_Msk) | SYS_GPC_MFPL_PC3MFP_I2C0_SMBAL;
...
int32_t main(void)
{
    ...
    while (ch != 0x30)
    {
        ...
        */
        ...
        printf("\n");
        printf("I2C0_SDA(PA.4), I2C0_SCL(PA.5), I2C_ALERT(PC.3), I2C_SUSPEND(PC.2)\n");
        printf("I2C1_SDA(PA.2), I2C1_SCL(PA.3), I2C_ALERT(PC.7), I2C_SUSPEND(PC.6)\n\n");
